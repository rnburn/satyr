...
#define SATYR_PRAGMA_SIMD_LINEAR_REDUCTION1(X, Y) \
  _Pragma(SATYR_STRINGIFY_IMPL(omp simd linear X reduction Y))
#define SATYR_PRAGMA_SIMD_LINEAR_REDUCTION(X, OP, Y) \
  SATYR_PRAGMA_SIMD_LINEAR_REDUCTION1((X), (OP:Y))
